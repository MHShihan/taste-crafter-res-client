...
const Dashboard = () => {
  return (
    <div className="max-w-7xl mx-auto  grid grid-cols-12  ">
      <div className=" col-span-3 lg:col-span-2 bg-[#D1A054] min-h-screen">
        <div className="ml-6  my-10 text-[#151515] font-cinzel">
      ...
      <div className="col-span-9 lg:col-span-10 bg-[#F6F6F6]">
        <Outlet></Outlet>
      </div>
    </div>
  );
