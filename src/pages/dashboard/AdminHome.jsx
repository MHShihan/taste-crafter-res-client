    ...
    <div className="bg-[#F6F6F6] min-h-screen">
      <div className="mx-10">
        ...
        <div className="stats grid grid-cols-4 gap-6 bg-[#F6F6F6]">
          {/* Revenue */}
          <div className="stat h-[150px] bg-gradient-to-r from-[#BB34F5] from-0% to-[#FCDBFF] to-100%  ">
          ...
          {/* Users */}
          <div className="stat bg-gradient-to-r from-[#D3A256] from-0% to-[#FDE8C0] to-100%">
            <div className="flex justify-center items-center gap-4 text-white">
              <div className="text-5xl">
                <FaUsers />
              </div>
          ...
          {/* Menu Items */}
          <div className="stat bg-gradient-to-r from-[#FE4880] from-0% to-[#FECDE9] to-100%">
            <div className="flex justify-center items-center gap-4 text-white">
              <div className="text-5xl">
                <GiChefToque />
              </div>
          ...
          <div className="stat bg-gradient-to-r from-[#6AAEFF] from-0% to-[#B6F7FF] to-100%">
            <div className="flex justify-center items-center gap-4 text-white">
              <div className="text-5xl">
                <FaTruck />
              </div>
